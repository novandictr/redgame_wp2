...
echo $data['user']['nama_admin'];
?>!</h1>
                                <p class="lead">Di Halaman Admin - Red Games | Web Portal Game Indonesia - <br> Pertama di
                                    Indonesia</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2023 <div class="bullet"></div> Program & Design by <a
                        href="syauqizaidan.github.io">Mahasiswa UBSI Pontianak</a>
                </div>
