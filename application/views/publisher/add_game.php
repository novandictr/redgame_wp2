...
<head>
    ...
    <title>Admin Dashboard - Red Games</title>
...
<body>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <a href="<?= base_url('publisher') ?>" style="font-size: 24px; font-weight:700" class="text-danger">Red Games</a>
                    </div>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Red Games - Add Store Game Data </h1>
                    </div>
    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright &copy; 2023 <div class="bullet"></div> Program & Design by <a href="syauqizaidan.github.io">Mahasiswa BSI Pontianak</a>
        </div>
