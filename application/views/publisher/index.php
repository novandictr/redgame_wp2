...
<head>
    ...
    <title>Publisher Dashboard - Red Games</title>
        ...
        <div class="main-wrapper">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - Red Games</div>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <a href="<?= base_url('admin') ?>" style="font-size: 24px; font-weight:700" class="text-danger">Red Games</a>
                    </div>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>img/hero.png">
                            <div class="hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['nama_publisher'];
                                                    ?>!</h1>
                                <p class="lead">Di Halaman Publisher - Red Games | Web Portal Game Indonesia - <br> Pertama di
                                    Indonesia</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2023 <div class="bullet"></div> Program & Design by <a href="syauqizaidan.github.io">Mahasiswa UBSI Pontianak</a>
                </div>
                <div class="footer-right">
                    Made with <span class="text-danger"> &#10084;</span> by Mahasiswa UBSI Pontianak
                </div>
            </footer>
        </div>
    </div>
