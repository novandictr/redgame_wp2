                ...
                <div id="kt_header" class="kt-header  kt-header--fixed " data-ktheader-minimize="on">
                                    ...
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                        ...
                                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                            <ul class="kt-menu__subnav">
                                                ...
                                                <li class="kt-menu__item " aria-haspopup="true"><a href="<?=base_url('games/adventure')?>"
                    ...
                    <div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
                        <a class="kt-header__brand-logo" href="<?=base_url('user')?>">
                            <p class="logo-tengah mt-3">Red Games.</p>
                        </a>
                    </div>
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="kt-widget19__wrapper">
                                                    ...
                                                    <div class="kt-widget19__text">
                                                        Red Games KEREN!!!, game buatan mahasiswa ubsi pontianak sangat menginspirasi dan tidak kalah seru di mainkan
                                                    </div>
                                                </div>
                                ...
                                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            <div class="kt-widget19__text">
                                                Ada banyak jenis game yang bisa di mainkan, saya sangat suka!!!
                                            </div>
                                        </div>
                                        <div class="kt-widget19__action">
                                            <a href="#" class="btn btn-sm btn-label-brand btn-bold">Read
                                ...
                                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            <div class="kt-widget19__text">
                                                banyak game yang bisa di coba, saya sangat penasaran :D
                                            </div>
                                        </div>
                                        <div class="kt-widget19__action">
                                            <a href="#" class="btn btn-sm btn-label-brand btn-bold">Read
