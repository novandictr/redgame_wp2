...
<head>
    ...
    <title>Red Games - Web Game Portal Indonesia</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light nav-colour" id="nav">
        <div class="container">
            <a class="navbar-brand text-white" href="<?=base_url('welcome')?>">Red Games.</a>
    ...
    <footer class="page-footer font-small pt-4 mt-5">
        <div class="container">
            ...
            <div class="container-fluid text-center text-md-left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <!-- Content -->
                        <h3 class="text-uppercase footer-text">Tentang Red Games.</h3>
                        <p>Red Games Adalah portal game pertama di indonesia, yang menyediakan fasilitas untuk
                            para
                            developer
            ...
            <div class="footer-copyright text-center small py-3">© 2020 Copyright :
                <a href="syauqizaidan.github.io" class="text-white"> Mahasiswa UBSI Pontianak</a>
            </div>
        </div>
        <!-- Copyright -->
