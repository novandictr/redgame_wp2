...
<footer class="page-footer font-small pt-4 mt-5">
    <div class="container">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <p>Red Games Adalah portal game pertama di indonesia, yang menyediakan fasilitas untuk para
                        developer
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center small py-3">© 2023 Copyright :
